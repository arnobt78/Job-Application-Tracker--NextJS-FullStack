...
<button
  type="button"
  class="border border-white/10 bg-background/50 backdrop-blur-sm shadow-xs hover:bg-accent/50 hover:border-white/20 hover:text-accent-foreground px-4 py-2 rounded-2xl transition"
>
  Outline Button
</button>
```
...
<button
  type="button"
  class="hover:bg-accent/50 hover:text-accent-foreground backdrop-blur-sm px-4 py-2 rounded-2xl transition"
>
  Ghost Button
</button>
```
...
<button
  type="button"
  class="bg-gradient-to-r from-secondary/70 via-secondary/50 to-secondary/30 text-secondary-foreground border border-secondary/30 shadow-xs hover:bg-secondary/80 backdrop-blur-sm px-4 py-2 rounded-2xl transition"
>
  Secondary
</button>
```
...
- **Small**: `h-8 px-3 rounded-2xl`
- **Large**: `h-10 px-6 rounded-2xl`
- **Icon**: `size-9` (square)
...
```html
<span
  class="text-xs border border-emerald-400/30 bg-gradient-to-r from-emerald-500/25 via-emerald-500/10 to-emerald-500/5 text-white px-2 py-0.5 rounded-2xl backdrop-blur-sm shadow-[0_10px_30px_rgba(16,185,129,0.2)]"
>
  Active
</span>
```
...
```html
<span
  class="text-xs border border-gray-400/30 bg-gradient-to-r from-gray-500/25 via-gray-500/10 to-gray-500/5 text-white/70 px-2 py-0.5 rounded-2xl backdrop-blur-sm shadow-[0_10px_30px_rgba(107,114,128,0.2)]"
>
  Inactive
</span>
```
...
```html
<div
  class="inline-flex items-center gap-1 px-2 py-1 text-xs border border-sky-400/30 bg-gradient-to-r from-sky-500/25 via-sky-500/10 to-sky-500/5 text-white rounded-2xl backdrop-blur-sm shadow-[0_10px_30px_rgba(2,132,199,0.2)]"
>
  Filter: Value
...
```html
<div
  class="inline-flex items-center gap-1 px-2 py-1 text-xs border border-amber-400/30 bg-gradient-to-r from-amber-500/25 via-amber-500/10 to-amber-500/5 text-white rounded-2xl backdrop-blur-sm shadow-[0_10px_30px_rgba(245,158,11,0.2)]"
>
  Rating: 5 ⭐
  <button class="ml-1 hover:text-destructive transition-colors">
    <X class="h-3 w-3" />
...
```html
<div
  class="inline-flex items-center gap-1 px-2 py-1 text-xs border border-violet-400/30 bg-gradient-to-r from-violet-500/25 via-violet-500/10 to-violet-500/5 text-white rounded-2xl backdrop-blur-sm shadow-[0_10px_30px_rgba(139,92,246,0.2)]"
>
  Search: "query"
  <button class="ml-1 hover:text-destructive transition-colors">
    <X class="h-3 w-3" />
...
<div class="relative flex-1 sm:max-w-sm">
  ...
  <input
    ...
    class="pl-9 pr-9 w-full bg-white/5 backdrop-blur-sm border border-white/20 text-white placeholder:text-white/40 focus-visible:border-sky-400 focus-visible:ring-sky-500/50 shadow-[0_10px_30px_rgba(2,132,199,0.15)] rounded-2xl px-3 py-2"
  />
...
<input
  type="text"
  class="w-full bg-white/5 backdrop-blur-sm border border-white/20 text-white placeholder:text-white/40 focus-visible:border-sky-400 focus-visible:ring-sky-500/50 rounded-2xl px-3 py-2 transition"
/>
```
...
```html
<select
  class="w-full bg-white/5 backdrop-blur-sm border border-white/20 text-white focus:border-sky-400 focus:ring-sky-500/50 rounded-2xl px-3 py-2"
>
...
```html
<button
  class="w-full sm:w-auto border border-white/20 bg-white/10 text-white hover:bg-white/20 backdrop-blur-sm shadow-[0_10px_30px_rgba(139,92,246,0.15)] rounded-2xl px-4 py-2 flex items-center gap-2"
>
...
```html
<div
  class="w-56 bg-popover/50 backdrop-blur-sm border border-white/10 text-white rounded-2xl shadow-lg p-1"
>
...
```html
<button
  class="bg-sky-500/20 text-sky-400 border border-sky-400/30 hover:bg-sky-500/30 px-3 py-1.5 rounded-2xl text-sm font-medium transition"
>
  All
</button>
```
...
```html
<button
  class="border border-white/20 bg-white/10 text-white hover:bg-white/20 backdrop-blur-sm px-3 py-1.5 rounded-2xl text-sm font-medium transition"
>
  Active
</button>
```
...
>
  ...
  >
    <!-- Primary Button -->
    <button
      class="rounded-2xl border border-primary/30 bg-gradient-to-r from-primary/70 via-primary/50 to-primary/30 shadow-[0_15px_35px_rgba(59,130,246,0.45)] backdrop-blur-sm"
    >
      <!-- Input Field -->
      <input
...
8. **Border radius consistency** - Use `rounded-[28px]` for cards, `rounded-[20px]` for list items, `rounded-2xl` for buttons/inputs
