...
| INT-0003 | C1 | — | Dev-Active | **ACTIVE** | `c1-dev-20260612` | 2026-06-12 | C1 user-driven work; resume @ `fd6f20c` |

## Resume INT-0003 (active — every session)

1. READ `.agile-v/STATE.md` + this file + `CLAUDE.md`
2. Git: `fd6f20c` on `main` (clean)
3. Verify: `npm run lint && npm run typecheck && npm test && npm run build` (29 tests)
